...
import FILTER_CONDITION from '../static/data/search_condition.json' assert { type: "json" };
import { Company } from "../types/Company.d.ts";
import { FilterType } from "../types/TypeIndex.d.ts";
...
export const getAllowSearchConditionKeys = (): string[] => {
  return FILTER_CONDITION.reduce<string[]>(
    (result: string[], currentValue: any) => {
