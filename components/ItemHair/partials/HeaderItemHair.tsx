    ...
    <>
      {status
        ? (
          <div
            className={`bg_badge
            ${status ? "bg-pink-dark" : "bg-brown"}
            text-cream-600 w-[32px] h-[42px] text-smm pt-1.5 -translate-y-px translate-x-1 lg:tracking-[2px] lg:pt-3 lg:translate-x-4 lg:w-[50px] lg:h-[67px] lg:text-xl`}
          >
            PR
          </div>
        )
