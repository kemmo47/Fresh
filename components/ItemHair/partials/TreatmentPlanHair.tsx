...
export const TreatmentPlanHair = ({ filterList }: TreatmentPlanHairProp) => {
  return (
    <div className="items-center rounded bg-gray-200 lg:bg-white h-full mb-1 mx-0.5 mt-0 px-0.5 py-1 lg:p-0 lg:pt-px lg:m-0 lg:grid lg:grid-cols-12">
        ...
        {filterList.map((x, index) => {
          return (
            <div
              ...
              } text-xss text-center py-0.5 rounded lg:rounded-[10px] lg:text-xl lg:py-[5px]`}
            >
              {x.filter_item}
            </div>
          );
