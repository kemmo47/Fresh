...
import { HeaderItemHair } from "./partials/HeaderItemHair.tsx";
import { FeeBodyPlanHair } from "./partials/FeeBodyPlanHair.tsx";
import { useModal } from "../../hook/useModal.tsx";
import { TreatmentPlanHair } from "./partials/TreatmentPlanHair.tsx";
import { BusinessHoursHair } from "./partials/BusinessHoursHair.tsx";
import { Campaign } from "./partials/Campaign.tsx";
import { ArrBlue } from "../Icon/ArrBlue.tsx";
import { IconNext } from "../Icon/IconNext.tsx";
import { ItemHairModal } from "./partials/ItemHairModal.tsx";
  ...
  return (
    <>
      <div className="relative rounded-[5px] mx-3 shadow-[0_0_1px_1px_brown] mt-3 lg:mt-8 lg:rounded-lg lg:p-[3px] lg:bg-white-transparent-light lg:shadow-[0px_2px_4px_1px] lg:shadow-violet-transparent">
        ...
        <div className="grid items-center grid-cols-12 lg:grid-cols-[6.25%_6.25%_6.25%_6.25%_6.25%_6.25%_6.25%_6.25%_6.25%_6.25%_6.25%_6.25%_6.25%_6.25%_6.25%_6.25%]">
