...
import { NewWindowWhite } from '@/components/Icon/NewWindowWhite';
import { Subtract } from '@/components/Icon/Subtract';

import styles from '../ItemHair.module.css';
      ...
      >
        {listItem.map((x) => {
          return (
            ...
            >
              <div
                className={`${styles.filterGreen} after:bg-[url('/assets/images/ico_check.svg')] after:absolute after:content-[''] after:w-6 after:h-6 after:top-1/2 after:left-0 after:-translate-y-1/2 after:translate-x-0.5 relative border border-gray-500 w-5 h-5`}
              ></div>
